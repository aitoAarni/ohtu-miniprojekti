...
class TestInterface(unittest.TestCase):
    ...
    def test_new_command_adds_a_new_reference_with_proper_input(self):
        ...
        self.user_io.add_input("year")
        self.user_io.add_input("volume")
        self.user_io.add_input("pages")
        self.user_io.add_input("publisher")
        self.user_io.add_input("volume_or_number")
        self.user_io.add_input("number")
        self.user_io.add_input("series")
        self.user_io.add_input("edition")
        self.user_io.add_input("address")
        self.user_io.add_input("month")
        self.user_io.add_input("note")
        self.user_io.add_input("exit")
